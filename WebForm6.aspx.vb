...
Public Class WebForm6
    ...
    Private Sub btnAPI_Click(sender As Object, e As EventArgs) Handles btnAPI.Click
        ...
        post_values.Add("x_login", "3Gz5bs4zA84K") ' your login ID
        post_values.Add("x_tran_key", "7X93tb87H4p2T4Sk") ' your transaction key
        ...
        post_values.Add("x_exp_date", "1125")
        ...
        lblAuthorizationCode.Text = post_values("x_login")
        lblTransactionID.Text = post_values("x_tran_key")
    End Sub
End Class