...
Public Class ProductDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Request.QueryString("ProductNO") <> "" Then
            ...
            If drProduct.Read() Then
                ...
                imgProduct.ImageUrl = "images/Database/" & Trim(drProduct.Item("ProductNO")) & ".jpg"
            End If
        End If
    End Sub
    Private Sub btnAddtoCart_Click(sender As Object, e As EventArgs) Handles btnAddtoCart.Click
        ...
        If drCheck.Read() Then
            ' updat the quantity
            tbQuantity.Text = tbQuantity.Text + drCheck.Item("Quantity")
            strSQLStatement = "Update Cart set Quantity = '" & CInt(tbQuantity.Text) & "' where ProductNo = '" & Trim(lblProductNo.Text) & "' and CartNo = '" & strCartNo & "'"
